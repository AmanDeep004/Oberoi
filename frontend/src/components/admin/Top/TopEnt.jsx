...
import { useGetTop5EntQuery } from "../../../app/api/admin/dashboardlice";

const TopEnt = ({ startDate, endDate }) => {
  const { data, isSuccess } = useGetTop5EntQuery({ startDate, endDate });
