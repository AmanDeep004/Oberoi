...
import { useGetTop5FoodQuery } from "../../../app/api/admin/dashboardlice";
import Loader from "../../Loader";
import CustomDataTable from "../CustomDataTable";

const TopFoods = ({ startDate, endDate }) => {
  const { data, isSuccess } = useGetTop5FoodQuery({ startDate, endDate });

  useEffect(() => {}, [startDate, endDate]);
  console.log(startDate, endDate, "aman");
  console.log(data, "toFoods");
          ...
          subHeaderComponent={
            <div className="row mb-4">
              <div className="col-md-5 mt-3">
                <h1 className="bold-font mobile-center fs-30">Top Foods</h1>
              </div>
            </div>
          }
          subHeader={true}
          defaultSortedField="occurrences"
