...
} from "../../app/api/admin/entertainmentItemsSlice";
import { useGetEntertainmentCatQuery } from "../../app/api/admin/entertainmentCatSlice";
import { useAddEntertainmentCatMutation } from "../../app/api/admin/entertainmentCatSlice";
import { useGetAllEntertainmentCategoryQuery } from "../../app/api/hotelSlice";
...
const EntertainmentModal = ({
  ...
  const [addEntertainment] = useAddEntertainmentMutation();
  const [updateEntertainment] = useUpdateEntertainmentMutation();
  const [addEntCat] = useAddEntertainmentCatMutation();
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      let res;
      if (edit) {
        res = await updateEntertainment(values);
      } else {
        res = await addEntertainment(values);
      }
  ...
  const handleCreate = async (formikProps, inputValue) => {
    const res = await addEntCat({ name: inputValue });
                                            ...
                                            <p className="text-end">
                                              <Link
                                                ...
                                                onClick={() => {
                                                  ...
                                                  // arrayHelpers.push(null);
                                                  arrayHelpers.push({ type: "file", link: null });
                                                }}
                                              >
                                                <span>+</span> Add Video
                                              </Link>
                                            ...
                                            >
                                              ...
                                              <div className="col-md-3">
                                                {formikProps.values?.videos &&
                                                  formikProps.values.videos[
                                                    index
                                                  ]?.link !== null && formikProps.values.videos[
                                                    index
                                                  ]?.type == "file" && (
                                                    <div className="col-md-3">
                                                      <div
                                              ...
                                              >
                                                <select
                                                  ...
                                                  type="button"
                                                  onChange={(e) =>
                                                    changeVideoType(e.target.value, formikProps, index)
                                                  }

                                                  value={formikProps?.values?.videos[index]?.type}
                                                >
